...
public class CNodeBasedEditor : EditorWindow
{
    /*
    ...
    {
        CNodeBasedEditor window = GetWindow<CNodeBasedEditor>();
    ...
    private void OnClickInPoint(CConnectionPoint1 inPoint)
    {
    ...
    private void OnClickOutPoint(CConnectionPoint1 outPoint)
    {
