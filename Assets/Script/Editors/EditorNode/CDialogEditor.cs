...
//namespace DNECore { 
public class CDialogEditor : NodeBasedEditor
{
    /*
    ...
    [MenuItem("GamePreferic/DialogSystem")]
    private static void OpenWindow()
    {
        //Se le asigna la ventana como valor por defecto
        CDialogEditor window = GetWindow<CDialogEditor>();
